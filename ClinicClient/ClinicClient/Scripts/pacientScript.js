var app = new Vue({
    ...
    methods: {
        ...
        deleteClick: function () {
            ...
            $.ajax({
                url: "https://localhost:44336/api/patients/" + this.selectedID,
                type: "DELETE",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                xhrFields: {
                ...
                success: function () {
                    for (var i = 0; i < self.fullData.length; i++) {
                        if (self.fullData[i].id === self.selectedID) {
                            ...
                            self.fullData[i].doctorId = data.doctorId;
                        }
                    }
        ...
        buttonDisabilityCheck: function () {
            this.nextButtonDisabled = (2 * this.currentPage * this.pageRowIndex >= this.fullData.length) ? true : false;
