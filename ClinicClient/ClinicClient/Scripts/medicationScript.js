var app = new Vue({
    ...
    methods: {
        addClick: function (event) {
            if (!this.selectedName || !this.selectedPatientID || !this.selectedDoses) {
                alert("Bad data!");
                return;
            }
            ...
            $.ajax({
                url: "https://localhost:44336/api/medications",
                type: "POST",
        ...
        deleteClick: function () {
            ...
            $.ajax({
                url: "https://localhost:44336/api/medications/" + this.selectedID,
                type: "DELETE",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                xhrFields: {
                ...
                success: function () {
                    for (var i = 0; i < self.fullData.length; i++) {
                        if (self.fullData[i].id === self.selectedID) {
                            ...
                            self.fullData[i].doses = data.doses;
